...
Route::get('/problems/get','WebServicesController@getProblems');
Route::get('/feelings/get','PostStatusController@getFeelings');
Route::get('/name', 'SystemUsersController@name');
Route::get('/post/delete','WebServicesController@deletePost');
Route::get('/mediawall','WebServicesController@mediaWall');
Route::post('/save/mediawall','WebServicesController@addSavedMedia');
Route::get('/delete/mediawall','WebServicesController@deleteSavedMedia');
Route::get('/interests/get','InterestController@getInterests');
Route::get('/specialization/get','SpecializationController@getSpecsFromDB');
...
// AIzaSyDvrw7iwjlbnD97cBVQm9zkFnWokMorBBA - places api
// How are you feeling today? What seems to be bothering you?
//gwapa ko oki
