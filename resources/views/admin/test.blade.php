<script
  ...
  <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyCtVIYJNRLIdoXH_ylyrCBk5cU4ps-qoQg&amp;sensor=false&amp;libraries=places"></script>
<script>
    /**
 *
...
<fieldset class="gllpLatlonPicker" style="max-height: 100px;">
    ...
    <input type="hidden" class="gllpLatitude" name="latitude" value="14.583583455156525"/>
    <input type="hidden" class="gllpLongitude" name="longitude" value="121.00341796875"/>
